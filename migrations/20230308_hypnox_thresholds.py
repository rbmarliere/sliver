...
with core.db.connection.atomic():
    migrate(
        migrator.drop_column(strategies.HypnoxStrategy._meta.table_name,
                             "p_h_threshold"),
        migrator.drop_column(strategies.HypnoxStrategy._meta.table_name,
                             "p_l_threshold"),
        migrator.drop_column(strategies.HypnoxStrategy._meta.table_name,
        ...
        migrator.rename_column(strategies.HypnoxStrategy._meta.table_name,
                               "tweet_filter",
                               "filter"),
        migrator.rename_column(strategies.HypnoxStrategy._meta.table_name,
                               "i_h_threshold",
        ...
        migrator.add_column(strategies.HypnoxStrategy._meta.table_name,
                            "mode",
                            mode),
        migrator.add_column(strategies.HypnoxStrategy._meta.table_name,
                            "operator",
    ...
    for st in q:
        core.db.Indicator \
            .delete() \
            .where(core.db.Indicator.strategy == st) \
            .execute()
